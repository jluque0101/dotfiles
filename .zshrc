...
# doing lolcat to this is tooo fancy
#archey3 
...
#alias ls='lsd -lahrt'
alias gt='gotop -b -s -a -p -r 6 -c monokai'
...
alias ll2="tree --dirsfirst -ChFupDaL 1"
alias ll3="tree --dirsfirst -ChFupDaL 1"

alias weather="curl wttr.in/Granada"

alias fastcommit="git add . && git commit -m 'This is my bind for fast commits | dev mode' && git push"
