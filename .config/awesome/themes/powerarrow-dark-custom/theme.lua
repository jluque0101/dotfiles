...
theme.tasklist_bg_focus                         =  "#222222" --"#1A1A1A"
...
theme.fs = lain.widget.fs({
    notification_preset = { fg = theme.fg_normal, bg = theme.bg_normal, font = "Roboto Mono Medium for Powerline 10" },
    settings = function()
